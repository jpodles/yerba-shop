    ...
    public partial class AllEntitesAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "tomus@gmail.com", "Tomasz", "Kowalski", "qwerty" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AddressId", "Email", "FirstName", "LastName", "Password" },
                values: new object[] { 2, 2, "michalek@gmail.com", "Michał", "Nogalski", "qwerty" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Łazy", "42-450", "Łazowska 4", 1 },
                    { 2, "Łazy", "42-450", "Michałowksa 5", 2 }
                });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "ProductId", "ReviewText", "TypeOfReview", "UserId" },
                values: new object[,]
                {
                    { 1, 1, "Smaczna Yerba polecam!", "Like", 1 },
                    { 2, 1, "Bardzo dobra klasyczna Yerba!", "Like", 2 }
                });
